...
public class TransactionsController implements Initializable {
    ...
    public void initialize(URL location, ResourceBundle resources) {
        ...
        bt_print.setOnAction(event -> {
            ...
            String path = null;
            if (token == 1){
                path = "E:/Transactions report "+tf_pname.getText()+" "+dtf.format(now)+".pdf";
                file = new File("E:/Transactions report "+tf_pname.getText()+" "+dtf.format(now)+".pdf");
            }else{
                path = "E:/Transactions report " + dtf.format(now) + ".pdf";
                file = new File("E:/Transactions report " + dtf.format(now) + ".pdf");
            }
